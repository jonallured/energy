    ...
    <Screen>
      ...
      <Screen.Body scroll>
        ...
        <Flex>
          ...
          <SubjectLineRow
            label="One Artwork"
            navigateTo={() => router.navigate("EmailSettingsOneArtwork")}
          />
          <SubjectLineRow
            label="Multiple artworks by the same artist"
            navigateTo={() =>
              router.navigate("EmailSettingsMultipleArtworksBySameArtist")
            }
          />
          <SubjectLineRow
            label="Multiple artworks and artists"
            navigateTo={() =>
              router.navigate("EmailSettingsMultipleArtworksAndArtists")
            }
          />
        </Flex>
        <Spacer y={6} />

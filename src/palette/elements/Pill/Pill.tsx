...
import { GestureResponderEvent, Image, Pressable, PressableProps } from "react-native"
...
export const Pill: React.FC<PillProps> = ({
  ...
  const enabledDisplayState = DisplayState.EnabledImprovedFlag
  const selectedDisplayState = DisplayState.SelectedImprovedFlag

import { Text, Box, Flex, TextProps, useColor } from "@artsy/palette-mobile"
...
/**
 * This can be removed once https://github.com/artsy/palette-mobile/pull/180
...
const VARIANTS: Record<
  AvatarSize,
  { diameter: number; textSize: TextProps["variant"] }
> = {
  xxs: {
    diameter: 30,
    textSize: "xs",
...
export const Avatar = ({ src, initials, size = DEFAULT_SIZE }: AvatarProps) => {
  ...
  const borderColor = color(isDarkMode ? "white100" : "black10")

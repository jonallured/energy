...
export const FileTypeIcon = ({ fileType }: { fileType?: string }) => {
  ...
  switch (fileType) {
    case "pdf":
      return (
        <Icon viewBox="0 0 24 24" width="50px" height="50px" testID="acrobat-icon">
          <Path
    ...
    case "png":
      return (
        <Icon viewBox="0 0 24 24" width="50px" height="50px" mt={2} testID="image-icon">
          <Path
    ...
    default:
      return (
        <Icon viewBox="0 0 24 24" width="50px" height="50px" mt={2} testID="default-icon">
          <Path
